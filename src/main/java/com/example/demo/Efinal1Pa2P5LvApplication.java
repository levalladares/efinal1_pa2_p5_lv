...
//		c2.setNumero("6543210");
//		c2.setPropietario(p2);
//		c2.setSaldo(new BigDecimal(50));
//		c2.setTipo("ahorros");
//		this.bancariaService.guardar(c2);
//		
//		this.iTransferenciaService.guardar("0123456", "6543210", new BigDecimal(20));
		
		CuentaBancaria cta= this.bancariaService.buscararPorNumero("0123456");
		System.out.println(cta.getSaldo());
		
		CuentaBancaria cta2= this.bancariaService.buscararPorNumero("6543210");
